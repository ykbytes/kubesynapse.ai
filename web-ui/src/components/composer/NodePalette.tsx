...
export function NodePalette({ agents }: NodePaletteProps) {
  ...
  return (
    <div className="w-48 border-r bg-muted/30 flex flex-col overflow-hidden shrink-0">
      <div className="px-3 py-2 text-xs font-semibold text-muted-foreground border-b uppercase tracking-wider">
        ...
        <div className="p-2 space-y-1">
          ...
          {agents.length === 0 && (
            <div className="text-center py-4 px-2">
              <Bot className="h-6 w-6 text-muted-foreground/60 mx-auto mb-1.5" />
