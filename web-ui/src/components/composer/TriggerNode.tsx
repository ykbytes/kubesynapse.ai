  ...
  return (
    <div
      ...
      className={cn(
        ...
        "px-5 py-3 shadow-md shadow-primary/10 min-w-[160px]",
        "flex flex-col items-center gap-1 transition-all duration-200",
        "hover:shadow-lg hover:shadow-primary/20 hover:border-primary/60",
    ...
    >
      ...
      <Handle
        ...
        className="!w-5 !h-2 !rounded-sm !bg-primary !border-0 !bottom-[-4px]"
      />
