    ...
    <div className="space-y-8">
      ...
      <div id="api-optimizations">
        ...
        <DocsTable headers={["Method", "Path", "Description"]} rows={[
          ...
          ["GET", "/api/v1/optimizations/candidates", "List candidates across studies with lineage, tags, lifecycle, and trial counts."],
          ["GET", "/api/v1/optimizations/candidates/{id}", "Load one candidate with its source study and trial evidence."],
          ["PATCH", "/api/v1/optimizations/candidates/{id}", "Update normalized candidate tags."],
          ["DELETE", "/api/v1/optimizations/candidates/{id}", "Archive a candidate while retaining its audit history."],
    ...
    <div className="space-y-8">
      ...
      <div id="optimizer-api">
        ...
        <DocsTable headers={["Method", "Path", "Purpose"]} rows={[
          ...
          ["GET", "/api/v1/optimizations/candidates", "Search the cross-study candidate registry, including optional archived records."],
          ["GET", "/api/v1/optimizations/candidates/{id}", "Load candidate, source-study lineage, and linked trial evidence."],
          ["PATCH", "/api/v1/optimizations/candidates/{id}", "Add, remove, or replace candidate tags."],
          ["DELETE", "/api/v1/optimizations/candidates/{id}", "Archive a candidate without deleting its manifests, trace, or trials."],
