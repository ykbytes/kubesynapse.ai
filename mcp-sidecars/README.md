...
| `browser-automation` | Headless browser navigation, screenshots, and forms |
...
| `github` | PRs, issues, releases, and repo management via GitHub API |
| `kubernetes-ops` | In-cluster resource queries and constrained mutations |
