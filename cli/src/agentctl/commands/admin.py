...
def admin_users_list() -> None:
    ...
    try:
        with console.status("[bold cyan]Loading users...[/bold cyan]", spinner="dots2"):
            with _api() as client:
...
def admin_user_create(
    ...
    try:
        with console.status(f"[bold cyan]Creating user {username}...[/bold cyan]", spinner="dots2"):
            with _api() as client:
...
def admin_user_update(
    ...
    try:
        with console.status(f"[bold cyan]Updating user {user_id}...[/bold cyan]", spinner="dots2"):
            with _api() as client:
...
def admin_user_delete(
    ...
    try:
        with console.status(f"[bold cyan]Deleting user {user_id}...[/bold cyan]", spinner="dots2"):
            with _api() as client:
